...
<template>
  ...
  <div class="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 p-2">
    <!-- Students -->
    <a href="#" class="block p-4 bg-white border rounded-lg shadow-sm hover:bg-gray-100">
      <h5 class="text-xl font-semibold flex justify-between items-center text-gray-900 mb-1">
        {{ dashboardStats.total_students }}
        <div class="w-8 h-8 bg-blue-500 rounded-full overflow-hidden relative">
          <svg class="absolute w-10 h-10 text-red-600 -left-1 p-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fill="white" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" />
          </svg>
        </div>
      </h5>
    ...
    <a href="#" class="block p-4 bg-white border rounded-lg shadow-sm hover:bg-gray-100">
      <h5 class="text-xl font-semibold flex justify-between items-center text-gray-900 mb-1">
        ...
        <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
          <svg class="w-5 h-5 text-white" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
            <path fill="white"
